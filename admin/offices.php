                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example ">
                                ...
                                if ($res) {
                                    while ($row = $res->fetch_assoc()) {
                                        ...
                                        echo "<td>" . "<a href=" . '../php/admin/modal/editOffice.php?num=' . $row['officeID'] . "   " . " class='material-icons' data-toggle='modal' data-toggle='tooltip' title='Edit' data-target='#editOffice'>mode_edit</a>" . "  &nbsp &nbsp &nbsp  " . "<a href=" . '../php/admin/modal/deleteOffice.php?num=' . $row['officeID'] . " " . " class='material-icons' data-toggle='modal' data-toggle='tooltip' title='Delete' data-target='#deleteOffice'>delete</a>" . "</td>";
                                        echo "</tr>";
                                    }
                                }
                            ...
                            <a href="../php/admin/modal/addOffice.php" class="btn btn-primary pull-right"
                               data-toggle="modal" data-target="#addOffice">Add Office</a>
                        </div>
                    </div>
                </div>
            </div>
