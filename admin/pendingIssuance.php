                                ...
                                if ($res) {
                                    while ($row = $res->fetch_assoc()) {
                                        echo "<tr>"
                                            ...
                                            . "<td>". "<a href=" . '../php/admin/modal/approveIssuance.php?num=' . $row['idd'] . "  " . " class='material-icons' data-toggle='modal' data-toggle='tooltip' title='View' data-target='#deleteIssuance'>check</a>" . " " . "<a href=" . '../php/admin/modal/viewPIssuance.php?num=' . $row['idd'] . "  " . " class='material-icons' data-toggle='modal' data-toggle='tooltip' title='View' data-target='#editIssuance'>visibility</a>" . "    " . "<a href=" . '../php/admin/modal/issueDelete.php?num=' . $row['idd'] . " " . " class='material-icons' data-toggle='modal' data-toggle='tooltip' title='Delete' data-target='#deleteIssuance'>delete</a>" . "</td>";
                                        echo "</tr>";
                                    }
