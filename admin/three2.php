        ...
        <div class="menu">
            <ul class="list">
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="#" onclick = "location.href='raos.php'"><strong>RAOS</strong></a>
                        </li>
                        <li>
                            <a href="#" onclick = "location.href='ssmi.php'"><strong>SSMI</strong></a>
                        </li>
                        <li>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            ...
                            <a href="../php/admin/modal/addItem.php" class="btn btn-primary pull-right"
