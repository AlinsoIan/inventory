        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 ">
                    <div class="card">
                        <div class="header">
                            <h2 class="text-center">Category 5: Office Supplies w/ ICS ( per PPSAS-FROM PAR TO ICS/ C.O.
                                TO M.O.O.E.)</h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    $sql = "SELECT items.itemID AS idd,description,units.unitName AS a,currentQuantity,inventory.reorderPoint AS c 
                                                  ,icsNo
                                         FROM items JOIN units ON items.unitID = units.unitID JOIN inventory ON items.itemID = inventory.itemID  WHERE categoryNo = '5'";
                                    $res = $conn->query($sql);
