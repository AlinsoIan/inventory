                    ...
                    <div class="body">
                        <div class="body table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                $sql = "SELECT division,offices.officeName,issuanceDate,issuanceTime,type,accounts.username AS a,issuanceID as idd FROM issuance JOIN offices ON issuance.officeID = offices.officeID
                                         JOIN accounts ON issuance.issuer = accounts.accountID";
                                $res = $conn->query($sql);
