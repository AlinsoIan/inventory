                    ...
                    <div class="body">
                        <div class="body table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                $sql = "SELECT accounts.username AS a,loginTime AS b,logoutTime AS c,loginDate AS d FROM accountlogs JOIN accounts ON accountlogs.accountID = accounts.accountID";
                                $res = $conn->query($sql);
                            ...
                            <h3 class="title pull-left">
                                ...
                                require '../php/db.php';
                                $sql = "SELECT COUNT(logID) FROM accountlogs";
                                $res = $conn->query($sql);
                                $r = $res->fetch_row();
