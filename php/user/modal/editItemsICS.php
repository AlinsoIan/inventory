...
<div class="col-md-12">
    <div class="modal-content">
        ...
        <div class="card-content table-responsive">
            <?php
            $id = $_GET['num'];
            echo "<form action=" . '../php/admin/itemUpdateICS.php?ii='.$id . " " . "method='post' >";
            ...
            ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                $sql = "SELECT icsNo FROM items WHERE itemID = '$a'";
                                $ress = $conn->query($sql);
                                $rr = $ress->fetch_row();

                                echo "<input type='text' disabled value = '" .$rr[0] . "'  name = 'icsNo' class='form-control'>";
                                ?>
                ...
                <div class="modal-footer">
                    <div class="text-center">
                        ...
                        session_start();
                        $temp = $_SESSION['temp'];
                        echo "<a href='../user/$temp' class='btn btn-danger pull-right' >CLOSE</a>";
                        ?>
                        <br>
                    </div>
                </div>
