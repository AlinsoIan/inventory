...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" ik><h4>General Services Office</h4></a>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                $sql = "SELECT items.itemID AS idd,description,units.unitName AS a,currentQuantity,brand,inventory.reorderPoint AS c 
                                         ...
                                         FROM items JOIN suppliers ON items.supplierID = suppliers.supplierID JOIN units ON items.unitID = units.unitID JOIN inventory ON items.itemID = inventory.itemID  WHERE categoryNo = '3'";
                                $res = $conn->query($sql);
                                ...
                                if ($res) {
                                    while ($row = $res->fetch_assoc()) {
                                        echo "<tr>"
                                            ...
                                            . "<td>" . "<a href=" . '../php/user/modal/editItems.php?num=' . $row['idd'] . "  " . " class='material-icons' data-toggle='modal' data-target='#editItems'>visibility</a>" . "<a href=" . '../php/user/modal/viewItemInfo.php?num=' . $row['idd'] . " " . " class='material-icons' data-toggle='modal' data-target='#itemInfo'>info_outline</a>" . "</td>";
                                        echo "</tr>";
                                    }
