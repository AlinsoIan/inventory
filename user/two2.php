            ...
            <div class="menu">
                 <ul class="list">
                    ...
                    <li  class="active">
                        ...
                        <ul class="ml-menu">
                            <li>
                            <a href="#" onclick="location.href='items2.ph'" data-toggle="tooltip" title="Office Supplies"><strong>Category 1</strong></a>
                        </li>
                        <li class="active">
                                     ...
                                     if($res){
                                         while($row = $res->fetch_assoc()){
                                             echo "<tr>"
                                                 ...
                                                 . "<td>" . "<a href=" .'../php/user/modal/editItems2.php?num=' .$row['idd'] . "  " . " class='material-icons' data-toggle='modal' data-target='#editItems'>visibility</a>" .  "<a href=" .'../php/user/modal/viewItemInfo.php?num=' .$row['idd'] . " " . " class='material-icons' data-toggle='modal' data-target='#itemInfo'>info_outline</a>" . "</td>";
                                             echo "</tr>";
                                         }
